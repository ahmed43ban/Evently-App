      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: FutureBuilder(
                        future: FireStoreHandler.getLoveEvents(FirebaseAuth.instance.currentUser!.uid),
              ...
              if(snapshot.connectionState==ConnectionState.waiting){
                ...
                return events.isEmpty
                    ?Text(StringsManger.no_events_yet.tr(),style: Theme.of(context).textTheme.titleMedium?.copyWith(
                  color: Colors.black
                ),)
                    :ListView.separated(
